...
if [ "X$distro" == "X" -a $deb -eq 0 ]; then
	...
	case $distro_rpm in
		...
		distro=rhel7.3
		;;
		redhat-release*-7.4*|centos-release-7-4*|sl-release-7.4*)
		distro=rhel7.4
		;;
		...
		distro=sles11sp4
		;;
		sles-release-12\.3*|*SLES*release-12\.3*)
		distro=sles12sp3
		;;
...
rpms=`find ${ofed}/$BINDIR -name "*mlnx-ofa_kernel-modules*" -o -name "*kernel*" -o -name "*knem*" -o -name "*srp*" -o -name "*iser*" -o -name "*mlnx-ofed-kernel-modules*" -o -name "*mlnx-en*" -o -name "*mlnx_en*" -o -name "*mlnx-sdp*" -o -name "*mlnx-rds*" -o -name "*mlnx-nfsrdma*" -o -name "*mlnx-nvme*" -o -name "*mlnx-rdma-rxe*"`
